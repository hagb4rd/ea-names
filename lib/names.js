...
var lib = require(path.resolve(__dirname + "/math.js"));
var WRGenerator = lib.WRGenerator;
var female = exports.female = new WRGenerator(Object.entries(females));
var male =	exports.male = new WRGenerator(Object.entries(males));
