...
//Module Class Person
function Person(data) {	if(!this||!(this instanceof Person)) {return new Person(data)}; Object.assign(this, data)};
//Static Gender Type
...
Person.random = function random(options) {
	...
	p.birthdate = randomAge(minAge,maxAge);
	return new Person(p);
}

//Proto
Person.prototype.gender = Person.Female;
Person.prototype.birthdate = randomAge(12,36);
...
function randomAge (minAge,maxAge) {
	...
	return new Date((+d)+days(rand(0,355)));
}